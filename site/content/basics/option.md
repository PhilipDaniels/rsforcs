...
Check | [is_none(&self) -> bool](https://doc.rust-lang.org/std/option/enum.Option.html#method.is_none) | Check if the option doesn't have a value, i.e. it's a `None`
|&nbsp;|&nbsp;|&nbsp;|
...
Get the value | [take(&mut self) -> Option&lt;T&gt;](https://doc.rust-lang.org/std/option/enum.Option.html#method.take) | Take the value out of the option, leaving a None in its place.
|&nbsp;|&nbsp;|&nbsp;|
...
Boolean logic | [and&lt;U&gt;(self, optb: Option&lt;U&gt;) -> Option&lt;U&gt;](https://doc.rust-lang.org/std/option/enum.Option.html#method.and) | Logical "AND" - return `None` if the first is `None`, else return the second option
|&nbsp;|&nbsp;|&nbsp;|
...
Transform the value | [map_or_else&lt;U, D, F&gt;(self, default: D, f: F) -> U](https://doc.rust-lang.org/std/option/enum.Option.html#method.map_or_else) | If `Some`, apply `f` to it and return the result, else return the result of calling the function `default`
|&nbsp;|&nbsp;|&nbsp;|
...
Chaining | [or_else&lt;F&gt;(self, f: F) -> Option&lt;T&gt;](https://doc.rust-lang.org/std/option/enum.Option.html#method.or_else) | If `Some` returns the value, else returns the result of calling the function `f`
|&nbsp;|&nbsp;|&nbsp;|
